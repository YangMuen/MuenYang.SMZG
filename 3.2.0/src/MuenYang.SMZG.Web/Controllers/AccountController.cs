...
using MuenYang.SMZG.Sessions;
using MuenYang.SMZG.Web.Controllers.Results;
using MuenYang.SMZG.Web.Models;
using MuenYang.SMZG.Web.Models.Account;
...
{
    public class AccountController : SMZGControllerBase
    {
